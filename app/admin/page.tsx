...
import ExploreAnalyticsPanel from '@/components/ExploreAnalyticsPanel';
import ProductAnalyticsPanel from '@/components/ProductAnalyticsPanel';
import FinanceFunnelPanel from '@/components/FinanceFunnelPanel';
...
// Connect Tabs Component
function ConnectTabs() {
  const [activeTab, setActiveTab] = useState<'posts' | 'groups' | 'reports'>('posts');

  return (
    <div className="space-y-6">
      {/* Tabs */}
      <div className="flex items-center gap-4 border-b border-light-green/20 pb-4">
        <button
  ...
  return (
    <main className="page-container relative">
      <div className="container-standard relative">
        ...
        {currentView === 'analytics' && (
          <div className="spacing-section">
            ...
            <div className="section-header">
              ...
              <p className="section-subtitle">Aggregated user data and insights</p>
            </div>
            <AnalyticsDashboard key="analytics-dashboard" />

            <div className="section-header mt-10">
              <h2 className="section-title">Product Usage (PostHog)</h2>
              <p className="section-subtitle">
                Feature-level event volume and highlights from PostHog analytics
              </p>
            </div>
            <ProductAnalyticsPanel />

            <div className="section-header mt-10">
              <h2 className="section-title">Finance Funnel (PostHog)</h2>
              <p className="section-subtitle">
                Drop-off and conversion between key finance events captured in PostHog
              </p>
            </div>
            <FinanceFunnelPanel />

            <div className="section-header">
              <h2 className="section-title">Explore Engagement</h2>
              <p className="section-subtitle">
                Likes, comments, session time, and event history from Explore
              </p>
            </div>
        ...
        {/* Mindfulness Content View */}
        {currentView === 'mindfulnessContent' && (
          <div className="space-y-6">
            <MindfulnessContent />
          </div>
        )}
              ...
              <div className="lg:col-span-1">
                <div className="card">
                  ...
                  <div className="relative mb-4">
                    ...
                    <input
                      type="text"
                      placeholder={privacyMode ? 'Search by username or ID...' : 'Search users...'}
                      value={searchQuery}
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <Avatar
                              ...
                              className="w-10 h-10 rounded-full object-cover bg-light-green/20"
                            />
              ...
              <div className="lg:col-span-2">
                {selectedUser ? (
                  <div className="space-y-6">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <Avatar
                            ...
                            size={64}
                            forceDicebear={privacyMode}
                            className="w-16 h-16 rounded-full object-cover bg-light-green/20"
                          />
                          <div>
                    ...
                    {currentView === 'finance' &&
                      (loadingFinance ? (
                        <div className="card text-center text-iki-white/60">
                            ...
                            <div className="card-compact">
                              ...
                              <div
                                className={`text-2xl font-bold ${
                                  financeData.summary.netBalance >= 0
                                    ? 'text-green-400'
                                    : 'text-red-400'
                                }`}
                              >
                                    ...
                                    <div className="flex items-center justify-between mb-3">
                                      <div>
                                        ...
                                        <div className="text-xs text-iki-white/60">
                                          Start Day: {budget.startDay} | Created:{' '}
                                      ...
                                      <div className="mb-3">
                                        ...
                                        <div className="space-y-1">
                                          {budget.incomes.map((income: any, idx: number) => (
                                            <div
                                              key={idx}
                                              className="flex items-center justify-between text-sm bg-iki-grey/10 rounded-lg p-2"
                                            >
                                              <div>
                                                <div className="text-iki-white">
                                                  {income.description || 'Income'}
                                                </div>
                                                <div className="text-xs text-iki-white/60">
                                                  {formatDate(income.addedAt)}
                                                </div>
                                              </div>
                                          ...
                                          {budget.categories.map((category: any) => (
                                            ...
                                            >
                                              ...
                                              <div className="flex items-center gap-3">
                                                ...
                                                <div
                                                  className={
                                                    'w-16 h-2 rounded-full bg-iki-grey/30 overflow-hidden'
                                                  }
                                                >
                                                  <div
                                                    className={`h-full ${
                                                      (category.spent || 0) > (category.limit || 0)
                                                        ? 'bg-red-400'
                                                        : 'bg-light-green'
                                                    }`}
                                                    style={{
                                        ...
                                        <div className="space-y-1 max-h-40 overflow-y-auto">
                                          {budget.expenses.slice(0, 5).map((expense: any) => (
                                            ...
                                            >
                                              <div>
                                                <div className="text-iki-white">
                                                  {expense.description || expense.businessName}
                                                </div>
                                                <div className="text-xs text-iki-white/60">
                                  ...
                                  >
                                    <div className="flex items-center justify-between mb-3">
                                      <div>
                                        ...
                                        <div className="text-xs text-iki-white/60">
                                          Due: {formatDate(debt.dueDate)} | {debt.repaymentPeriod}{' '}
                                          months
                                        </div>
                                      </div>
                                      <div className="text-right">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                      <div>
                                        ...
                                        <span className="text-iki-white ml-2">
                                  ...
                                  >
                                    <div className="flex items-center justify-between mb-3">
                                      <div>
                                        ...
                                        <div className="text-xs text-iki-white/60">
                                          Deadline: {formatDate(goal.deadline)} | Streak:{' '}
                                          {goal.streak} days
                                        </div>
                                      </div>
                                      <div className="text-right">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                      ...
                                      <div>
                                        ...
                                        <span className="text-iki-white ml-2">
                                          {formatDate(goal.lastContributionDate)}
                                        </span>
                                      </div>
                                    </div>
                    ...
                    {currentView === 'wellsphere' &&
                      (loadingWellsphere ? (
                        ...
                        <>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                            ...
                            <div className="card-compact">
                              ...
                              <div className="text-2xl font-bold text-iki-white truncate">
                                {wellsphereData.summary.hasCondition
                                  ? wellsphereData.condition || 'Yes'
                                  : 'None'}
                              </div>
                            </div>
                            <div className="card-compact">
                                ...
                                <div className="bg-iki-grey/20 rounded-xl p-4 border border-light-green/10">
                                  <div className="space-y-3 text-sm">
                                    {wellsphereData.conditionData.condition_description && (
                                      <div>
                                        <div className="text-xs font-semibold text-iki-white/60 mb-1">
                                          Description
                                        </div>
                                        <div className="text-iki-white">
                                          {wellsphereData.conditionData.condition_description}
                                    ...
                                    {wellsphereData.conditionData.common_symptoms &&
                                      wellsphereData.conditionData.common_symptoms.length > 0 && (
                                        <div>
                                          <div className="text-xs font-semibold text-iki-white/60 mb-1">
                                            Common Symptoms
                                          </div>
                                          <div className="flex flex-wrap gap-2">
                                            {wellsphereData.conditionData.common_symptoms.map(
                                              (symptom: string, idx: number) => (
                                                <span
                                                  key={idx}
                                                  className="px-2 py-1 bg-iki-grey/30 rounded-lg text-iki-white text-xs"
                                                >
                                                  {symptom}
                                                </span>
                                              )
                                  ...
                                  >
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                      <div>
                                        ...
                                        <span className="text-iki-white ml-2">
                                          {formatDate(drug.startDate)}
                                        </span>
                                      </div>
                                      <div>
                                        <span className="text-iki-white/60">End Date:</span>
                                        <span className="text-iki-white ml-2">
                                          {formatDate(drug.endDate) || 'Ongoing'}
                                        </span>
                                      </div>
                                      {drug.frequency && (
                                        <div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {wellsphereData.emergencyContacts.map((contact) => (
                                  <div
                                    ...
                                    className="bg-iki-grey/20 rounded-xl p-4 border border-light-green/10"
                                  >
                                    <div className="font-semibold text-iki-white mb-2">
                                      {contact.name}
                                    </div>
                                    <div className="space-y-1 text-sm">
                                      ...
                                      <div className="text-iki-white/60">
                              ...
                              <div className="bg-iki-grey/20 rounded-xl p-4 border border-light-green/10">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  <div>
                                    ...
                                    <div className="text-iki-white">
                                      {wellsphereData.medicalInfo.bloodType}
                                    </div>
                                  </div>
                                  {wellsphereData.medicalInfo.conditions &&
                                    wellsphereData.medicalInfo.conditions.length > 0 && (
                                      <div>
                                        <div className="text-xs font-semibold text-iki-white/60 mb-2">
                                          Conditions
                                        </div>
                                        <div className="flex flex-wrap gap-2">
                                          {wellsphereData.medicalInfo.conditions.map(
                                            (condition: string, idx: number) => (
                                              <span
                                                key={idx}
                                                className="px-2 py-1 bg-red-400/20 rounded-lg text-red-300 text-xs"
                                              >
                                                {condition}
                                              </span>
                                            )
                                  ...
                                  {wellsphereData.medicalInfo.allergies &&
                                    wellsphereData.medicalInfo.allergies.length > 0 && (
                                      <div>
                                        <div className="text-xs font-semibold text-iki-white/60 mb-2">
                                          Allergies
                                        </div>
                                        <div className="flex flex-wrap gap-2">
                                          {wellsphereData.medicalInfo.allergies.map(
                                            (allergy: string, idx: number) => (
                                              <span
                                                key={idx}
                                                className="px-2 py-1 bg-orange-400/20 rounded-lg text-orange-300 text-xs"
                                              >
                                                {allergy}
                                              </span>
                                            )
                                  ...
                                  {wellsphereData.medicalInfo.medications &&
                                    wellsphereData.medicalInfo.medications.length > 0 && (
                                      <div>
                                        <div className="text-xs font-semibold text-iki-white/60 mb-2">
                                          Medications
                                        </div>
                                        <div className="flex flex-wrap gap-2">
                                          {wellsphereData.medicalInfo.medications.map(
                                            (med: string, idx: number) => (
                                              <span
                                                key={idx}
                                                className="px-2 py-1 bg-blue-400/20 rounded-lg text-blue-300 text-xs"
                                              >
                                                {med}
                                              </span>
                                            )
                            ...
                            <div className="card">
                              ...
                              <div className="space-y-2 max-h-96 overflow-y-auto">
                                {wellsphereData.symptoms.map((symptom) => (
                                  <div
                                    key={symptom.id}
                                    className="bg-iki-grey/20 rounded-xl p-3 border border-light-green/10"
                                  >
                                    <div className="flex items-center justify-between mb-2">
                                      <div className="flex-1">
                                          ...
                                          {symptom.tags && symptom.tags.length > 0 && (
                                            <div className="flex gap-1">
                                              {symptom.tags.map((tag: string, idx: number) => (
                                                <span
                                                  key={idx}
                                                  className="px-2 py-0.5 bg-iki-grey/30 rounded text-xs text-iki-white/80"
                                                >
                                                  {tag}
                                                </span>
                                              ))}
                                        ...
                                        {symptom.notes && (
                                          <div className="text-xs text-iki-white/80 mt-2">
                                            {symptom.notes}
                                          </div>
                                        )}
                                      </div>
                          ...
                          {/* Daily Check-Ins */}
                          {wellsphereData.dailyCheckIns &&
                            wellsphereData.dailyCheckIns.length > 0 && (
                              <div className="card">
                                <div className="flex items-center justify-between mb-4">
                                  <h3 className="text-xl font-bold text-iki-white flex items-center gap-2">
                                  ...
                                  {wellsphereData.dailyCheckIns.map((checkIn) => (
                                    ...
                                    >
                                      ...
                                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
                                        <div>
                                          <div className="text-xs text-iki-white/60 mb-1">
                                            Sleep Quality
                                          </div>
                                          <div className="text-iki-white font-semibold">
                                            {checkIn.sleepQuality || 'N/A'}
                                          </div>
                                        </div>
                                        <div>
                                          <div className="text-xs text-iki-white/60 mb-1">
                          ...
                          <div className="bg-iki-grey/20 rounded-xl p-4 border border-light-green/10">
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <span className="text-iki-white ml-2">
                                  {selectedUser.activityLevel || 'N/A'}
                                </span>
                              </div>
                              <div>
                                <span className="text-iki-white/60">Body Weight:</span>
                                <span className="text-iki-white ml-2">
                                  {selectedUser.bodyWeightKg
                                    ? `${selectedUser.bodyWeightKg} kg`
                                    : 'N/A'}
                                </span>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <span
                                  className={`ml-2 ${selectedUser.isOnline ? 'text-green-400' : 'text-iki-white/60'}`}
                                >
                            ...
                            {selectedUser.healthStats && selectedUser.healthStats.length > 0 && (
                              <div className="mt-4 pt-4 border-t border-light-green/10">
                                <span className="text-iki-white/60 text-sm mb-2 block">
                                  Health Stats:
                                </span>
                                    ...
                                    <div className="flex items-center justify-between">
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                          ...
                                          {mood.notes && (
                                            <div className="text-sm text-iki-white/80 mt-1">
                                              {mood.notes}
                                            </div>
                                          )}
                                        </div>
                                  ...
                                  >
                                    <div className="flex items-start justify-between">
                                      <div className="flex-1">
                                        ...
                                        {meal.notes && (
                                          <div className="text-sm text-iki-white/80 mt-2">
                                            {meal.notes}
                                          </div>
                                        )}
                                      </div>
                            ...
                            <div className="card">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div className="bg-iki-grey/20 rounded-xl p-4">
                                  <div className="text-sm text-iki-white/60 mb-1">
                                    Total Sessions
                                  </div>
                                  <div className="text-2xl font-bold text-iki-white">
                                    {mindfulnessData.stats.totalSessions}
                                  </div>
                                </div>
                                <div className="bg-iki-grey/20 rounded-xl p-4">
                                  <div className="text-sm text-iki-white/60 mb-1">
                                  ...
                                  <div className="text-2xl font-bold text-iki-white">
                                    {mindfulnessData.stats.totalMinutes}
                                  </div>
                                </div>
                                <div className="bg-iki-grey/20 rounded-xl p-4">
                                  <div className="text-sm text-iki-white/60 mb-1">
                                  ...
                                  <div className="text-2xl font-bold text-light-green">
                                    {mindfulnessData.stats.currentStreak} days
                                  </div>
                                </div>
                                <div className="bg-iki-grey/20 rounded-xl p-4">
                                  <div className="text-sm text-iki-white/60 mb-1">
                                  ...
                                  <div className="text-2xl font-bold text-iki-white">
                                    {mindfulnessData.stats.longestStreak} days
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div className="bg-iki-grey/20 rounded-xl p-4 border border-light-green/10">
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                                  <div>
                                    <span className="text-iki-white/60">Username:</span>
                                    <span className="text-iki-white ml-2">
                                      {fitnessData.profile.username}
                                    </span>
                                  </div>
                                  <div>
                                    <span className="text-iki-white/60">Experience:</span>
                                    <span className="text-iki-white ml-2">
                                      {fitnessData.profile.experienceLevel || 'N/A'}
                                    </span>
                                  </div>
                                  <div>
                                    <span className="text-iki-white/60">Goal:</span>
                                    <span className="text-iki-white ml-2">
                                      {fitnessData.profile.fitnessGoal || 'N/A'}
                                    </span>
                                  </div>
                                  <div>
                                    <span className="text-iki-white/60">Location:</span>
                                    <span className="text-iki-white ml-2">
                                      {fitnessData.profile.trainingLocation || 'N/A'}
                                    </span>
                                  </div>
                                  <div>
                                    <span className="text-iki-white/60">Frequency:</span>
                                    <span className="text-iki-white ml-2">
                                      {fitnessData.profile.workoutFrequency || 'N/A'}
                                    </span>
                                  </div>
                                  <div>
                                    <span className="text-iki-white/60">Duration:</span>
                                    <span className="text-iki-white ml-2">
                                      {fitnessData.profile.workoutDurationMinutes
                                        ? `${fitnessData.profile.workoutDurationMinutes} min`
                                        : 'N/A'}
                                    </span>
                                  </div>
                                  {fitnessData.profile.equipment &&
                                    fitnessData.profile.equipment.length > 0 && (
                                      <div className="md:col-span-3">
                                        <span className="text-iki-white/60">Equipment:</span>
                                        <div className="flex flex-wrap gap-2 mt-2">
                                          {fitnessData.profile.equipment.map(
                        ...
                        <>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="card-compact">
                              ...
                              <div className="text-2xl font-bold text-iki-white">
                                {onboardingData.summary.fitnessOnboardingComplete
                                  ? 'Complete'
                                  : onboardingData.summary.hasFitnessOnboarding
                                    ? 'Incomplete'
                                    : 'None'}
                              </div>
                            </div>
                            <div className="card-compact">
                              ...
                              <div className="text-2xl font-bold text-iki-white">
                                {onboardingData.summary.nutritionOnboardingComplete
                                  ? 'Complete'
                                  : onboardingData.summary.hasNutritionOnboarding
                                    ? 'Incomplete'
                                    : 'None'}
                              </div>
                            </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                                  ...
                                  {onboardingData.mainOnboarding.bodyWeightKg && (
                                    <div>
                                      ...
                                      <span className="text-iki-white ml-2">
                                        {onboardingData.mainOnboarding.bodyWeightKg} kg
                                      </span>
                                    </div>
                                  )}
                                  {onboardingData.mainOnboarding.heightCm && (
                                    <div>
                                      ...
                                      <span className="text-iki-white ml-2">
                                        {onboardingData.mainOnboarding.heightCm} cm
                                      </span>
                                    </div>
                                  )}
                          ...
                          {onboardingData.fitnessOnboarding && (
                            <div className="card">
                              ...
                              <div className="bg-iki-grey/20 rounded-xl p-4 border border-light-green/10">
                                <div className="mb-2">
                                  <span className="text-xs font-semibold text-iki-white/60">
                                    Status:
                                  </span>
                                  <span
                          ...
                          <OnboardingSummary
                            ...
                            enhancedInterests={
                              onboardingData.userTags || onboardingData.enhancedInterests
                            }
                          />
                              ...
                              <div className="bg-iki-grey/20 rounded-xl p-4 border border-light-green/10">
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                  <div>
                                    ...
                                    <span
                                      className={`ml-2 font-semibold ${onboardingData.enhancedMedical.hasMedicalCondition ? 'text-red-400' : 'text-green-400'}`}
                                    >
                                      {onboardingData.enhancedMedical.hasMedicalCondition
                                        ? 'Yes'
                                        : 'No'}
                                    </span>
                                  </div>
                                  ...
                                  {onboardingData.enhancedMedical.medicalDetails && (
                                    <div className="col-span-2">
                                      ...
                                      <div className="text-iki-white mt-1">
                                        {onboardingData.enhancedMedical.medicalDetails}
                                      </div>
                                    </div>
                                  )}
                              ...
                              <div className="bg-iki-grey/20 rounded-xl p-4 border border-light-green/10">
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                  <div>
                                    ...
                                    <span
                                      className={`ml-2 font-semibold ${onboardingData.enhancedSecurity.biometricEnabled ? 'text-green-400' : 'text-iki-white/60'}`}
                                    >
                                      {onboardingData.enhancedSecurity.biometricEnabled
                                        ? 'Yes'
                                        : 'No'}
                                    </span>
                                  </div>
                                  <div>
                                    ...
                                    <span
                                      className={`ml-2 font-semibold ${onboardingData.enhancedSecurity.pinEnabled ? 'text-green-400' : 'text-iki-white/60'}`}
                                    >
                                  ...
                                  {onboardingData.enhancedSecurity.pinSetAt && (
                                    <div className="col-span-2">
                                      ...
                                      <span className="text-iki-white ml-2">
                                        {formatDate(onboardingData.enhancedSecurity.pinSetAt)}
                                      </span>
                                    </div>
                                  )}
                                </div>
                  ...
                  <div className="glass rounded-3xl p-6 border border-light-green/10 text-center">
                    ...
                    <p className="text-iki-white/60">
                      Select a user to view their {currentView} data
                    </p>
                  </div>
                )}
              </div>
